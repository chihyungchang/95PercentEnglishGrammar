    ...
    >
      ...
      <div className="p-6 pl-14 h-full overflow-y-auto">
        ...
        <div className="text-center mb-5 pb-3 border-b-2 border-[#1a1a2e]">
          ...
          <p className="text-base text-gray-500 mt-1">主谓宾的其他兄弟们</p>
        </div>
        ...
        <Section num={5} title="主谓宾补" en="S + V + O + C">
          ...
          <div className="bg-[#f5eef8] border border-[#8e44ad] rounded-lg p-3 mt-2">
            <p className="text-sm font-semibold text-[#8e44ad] mb-2">补语可以是：</p>
            <div className="flex gap-3">
              <span className="text-sm bg-white border border-gray-200 px-2 py-1 rounded">
        ...
        <Section num={6} title="There be 句型" en="表达「存在」">
          <div className="bg-gray-50/90 border border-gray-200 rounded-lg p-3">
            <div className="flex items-center justify-center gap-2 text-lg font-semibold">
              ...
              <span className="text-gray-400 text-base">(+介宾)</span>
            </div>
          ...
          <div className="grid grid-cols-2 gap-3 mt-3">
            <div className="bg-white border border-gray-200 rounded-lg p-3">
              ...
              <p className="text-sm text-gray-500">有条狗</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-3">
              <p className="font-mono text-base mb-1">
              ...
              <p className="text-sm text-gray-500">那棵树下有条狗</p>
            </div>
          </div>
        </Section>

        <div className="absolute bottom-4 right-6 font-mono text-sm text-gray-400">3</div>
      </div>
    </div>
  )
})
...
function ExampleCard({ en, zh, notes, highlight, highlightType }) {
  return (
    <div className="bg-white border border-gray-200 rounded-lg p-3">
      <p className="font-mono text-base mb-1">{en}</p>
