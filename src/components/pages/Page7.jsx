    ...
    >
      ...
      <div className="p-6 pl-14 h-full overflow-y-auto">
        ...
        <div className="text-center mb-4 pb-2 border-b-2 border-[#1a1a2e]">
          ...
          <p className="text-sm text-gray-500 mt-1">Attributive Clause</p>
        </div>
        ...
        <Section num={1} title="什么是定语？" en="What is Attributive?">
          <div className="bg-[#fef9e7] border border-[#d4a017] rounded-lg p-4">
            ...
            <p className="text-xs text-gray-600 mb-2">汉语中「的」前面的内容：</p>
            <div className="bg-white rounded px-3 py-2 text-center">
              ...
              <div className="flex justify-center gap-8 text-[10px] text-gray-500 mt-1">
                <span>↑ 定语</span>
                <span>↑ 名词</span>
              </div>
            </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="bg-[#e8f0fe] border border-[#2d5aa0] rounded-lg p-3">
              <div className="flex items-center gap-2 mb-2">
                <span className="w-5 h-5 bg-[#2d5aa0] text-white text-[10px] font-mono rounded-full flex items-center justify-center">1</span>
                <span className="font-semibold text-[#2d5aa0]">形容词</span>
              </div>
              <p className="text-xs text-gray-500">短一些</p>
              <p className="text-xs text-gray-600 mt-1">放在名词<span className="font-bold">前面</span></p>
            </div>
            <div className="bg-[#f5eef8] border border-[#8e44ad] rounded-lg p-3">
              <div className="flex items-center gap-2 mb-2">
                <span className="w-5 h-5 bg-[#8e44ad] text-white text-[10px] font-mono rounded-full flex items-center justify-center">2</span>
                <span className="font-semibold text-[#8e44ad]">短语或从句</span>
              </div>
              <p className="text-xs text-gray-500">长一些</p>
              <p className="text-xs text-gray-600 mt-1">放在名词<span className="font-bold">后面</span></p>
            </div>
          </div>
        </Section>
        ...
        <Section num={3} title="定语的位置" en="Position">
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-3">
            <div className="flex items-center justify-center gap-2 text-sm">
              <span className="bg-[#e8f0fe] text-[#2d5aa0] px-2 py-1 rounded text-xs">定①</span>
              <span className="text-[#c0392b] font-bold">主</span>
              <span className="bg-[#f5eef8] text-[#8e44ad] px-2 py-1 rounded text-xs">定②</span>
        ...
        {/* 例句 */}
        <div className="mt-4">
          <h3 className="font-serif text-base font-bold mb-3">例句</h3>

          {/* 定① 例子 */}
          <div className="bg-white border border-gray-200 rounded-lg p-3 mb-3">
            <div className="flex items-center gap-2 mb-2">
              <span className="bg-[#2d5aa0] text-white text-[10px] px-2 py-0.5 rounded">定①</span>
              <span className="text-xs text-gray-500">形容词作定语</span>
            </div>
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-3">
            <div className="flex items-center gap-2 mb-2">
              <span className="bg-[#8e44ad] text-white text-[10px] px-2 py-0.5 rounded">定②</span>
              <span className="text-xs text-gray-500">介宾短语作定语</span>
            </div>
            <p className="font-mono text-sm mb-2">
        ...
        <div className="absolute bottom-4 right-6 font-mono text-xs text-gray-400">7</div>
      </div>
    </div>
  )
})
