    ...
    >
      ...
      <div className="p-6 pl-14 h-full overflow-y-auto">
        ...
        <div className="text-center mb-5 pb-3 border-b-2 border-[#1a1a2e]">
          ...
          <p className="text-sm text-gray-500 mt-1">所有英文句子能够被分成三类</p>
        </div>
        ...
        <Section num={2} title="并列句" en="Compound Sentence">
          <div className="bg-gray-50/90 border border-gray-200 rounded-lg p-4">
            <div className="flex items-center justify-center gap-2 flex-wrap text-sm">
              ...
              <span className="bg-[#fef9e7] border border-[#d4a017] rounded px-2 py-1 text-[#d4a017] font-mono text-xs">
                并列词
              </span>
              <span className="text-gray-400 font-mono">+</span>
              <SVOGroup />
        ...
        <Section num={3} title="复合句" en="Complex Sentence">
          <div className="bg-gray-50/90 border border-gray-200 rounded-lg p-4">
            <div className="flex items-center justify-center gap-2 flex-wrap text-sm">
              ...
              <span className="text-gray-400 font-mono">+</span>
              <span className="bg-[#eafaf1] border border-[#1e8449] rounded px-2 py-1 text-[#1e8449] font-mono text-xs">
                引导词
              </span>
              <span className="text-gray-400 font-mono">+</span>
        ...
        <div className="grid grid-cols-2 gap-4 mt-5">
          <div className="bg-white border border-gray-200 rounded-lg p-3">
            <h3 className="font-serif text-sm font-bold mb-2 pb-1.5 border-b border-gray-200">主谓宾释义</h3>
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-3">
            <h3 className="font-serif text-sm font-bold mb-2 pb-1.5 border-b border-gray-200">从句类型</h3>
        ...
        <div className="absolute bottom-4 right-6 font-mono text-xs text-gray-400">1</div>
      </div>
    </div>
  )
})
...
function SVOGroup({ color = 'accent', label }) {
  ...
  return (
    <div className="text-center">
      <div className={`inline-flex items-center gap-1 border-2 ${s.border} ${s.bg} rounded-full px-3 py-1 text-sm`}>
...
function RefItem({ label, color, en, desc, example }) {
  return (
    <div className="flex items-center gap-2 py-1 text-xs border-t border-dashed border-gray-100 first:border-0">
      <span className="font-bold min-w-[28px]" style={{ color }}>{label}</span>
      <span className="font-mono text-[10px] text-gray-400">{en}</span>
...
function ClauseItem({ num, name, aka }) {
  return (
    <div className="flex items-center gap-2 py-1 text-xs border-t border-dashed border-gray-100 first:border-0">
      <span className="w-4 h-4 bg-[#1e8449] text-white text-[9px] font-mono rounded-full flex items-center justify-center">
        {num}
      </span>
      <span className="font-semibold">{name}</span>
      <span className="text-[10px] text-gray-400 ml-auto">{aka}</span>
    </div>
  )
}
