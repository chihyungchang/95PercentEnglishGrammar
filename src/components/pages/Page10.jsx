    ...
    >
      ...
      <div className="p-6 pl-14 h-full overflow-y-auto">
        ...
        <div className="text-center mb-4 pb-2 border-b-2 border-[#1a1a2e]">
          ...
          <p className="text-sm text-gray-500 mt-1">副词与状语例句</p>
        </div>
        ...
        <div className="bg-[#e8f0fe] border border-[#2d5aa0]/30 rounded-lg p-2 mb-3">
          <p className="text-xs text-center">
            ...
            <span className="bg-white px-1 py-0.5 rounded mx-1 text-[#c0392b] font-mono text-[10px]">主</span>
            <span className="bg-white px-1 py-0.5 rounded mx-1 text-[#1e8449] font-mono text-[10px]">谓</span>
            <span className="bg-white px-1 py-0.5 rounded mx-1 text-[#2d5aa0] font-mono text-[10px]">宾</span>
            之外的
          </p>
        </div>
        ...
        <Section num={2} title="状语例子" en="Adverbial Examples">
          <div className="space-y-2">
            ...
            <SubSection num="i" title="时间状语" en="Time" color="#e74c3c">
              <p className="font-mono text-xs">He came <span className="text-[#e74c3c] underline">yesterday</span>.</p>
              <p className="font-mono text-xs"><span className="text-[#e74c3c] underline">Yesterday</span> he came.</p>
              <p className="text-[10px] text-gray-400 mt-1">位置灵活</p>
            </SubSection>

            {/* ii. 地点状语 */}
            <SubSection num="ii" title="地点状语" en="Place" color="#3498db">
              <p className="font-mono text-xs">He celebrated his birthday <span className="text-[#3498db] underline">at school</span>.</p>
              <p className="font-mono text-xs"><span className="text-[#3498db] underline">At school</span> he celebrated his birthday.</p>
              <p className="text-[10px] text-gray-400 mt-1">位置灵活</p>
            </SubSection>

            {/* iii. 原因状语从句 */}
            <SubSection num="iii" title="原因状语从句" en="Causal" color="#e67e22">
              <p className="text-[10px] text-gray-500 mb-1">He likes spring...</p>
              ...
              <p className="text-[10px] text-gray-400 mt-1">除了 since/for 可放句首外，其它都靠后</p>
            </SubSection>
          </div>
        </Section>
