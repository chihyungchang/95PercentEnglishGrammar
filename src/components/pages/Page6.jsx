    ...
    >
      ...
      <div className="p-6 pl-14 h-full overflow-y-auto">
        ...
        <div className="text-center mb-4 pb-2 border-b-2 border-[#1a1a2e]">
          ...
          <p className="text-sm text-gray-500 mt-1">名词性从句的另外两种形式</p>
        </div>
        ...
        <Section num={3} title="表语从句" en="Predicative Clause">
          <div className="bg-white border border-gray-200 rounded-lg p-3">
            ...
            <p className="text-xs text-gray-500 mt-2 text-center">事实是他喜欢足球</p>
          </div>
        </Section>
        ...
        <Section num={4} title="同位语从句" en="Appositive Clause">
          ...
          <div className="bg-[#f5eef8] border border-[#8e44ad] rounded-lg p-3 mb-3">
            <p className="text-xs font-semibold text-[#8e44ad] mb-2">首先，什么是同位语？</p>
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-3 mb-3">
            <p className="text-xs font-semibold mb-2">同位语从句位置：</p>
        ...
        <div className="absolute bottom-4 right-6 font-mono text-xs text-gray-400">6</div>
      </div>
    </div>
  )
})
