    ...
    >
      ...
      <div className="p-6 pl-14 h-full overflow-y-auto">
        ...
        <div className="text-center mb-4 pb-2 border-b-2 border-[#1a1a2e]">
          ...
          <p className="text-base text-gray-500 mt-1">从句如何变成句子成分</p>
        </div>

        {/* 从句结构分析 */}
        <div className="bg-[#fef9e7] border border-[#d4a017] rounded-lg p-4 mb-4">
          <h3 className="font-serif text-base font-bold text-[#d4a017] mb-3">例：名词性从句结构</h3>
          <div className="bg-white rounded-lg p-3 mb-3">
            ...
            <div className="flex justify-center mt-2">
              <div className="bg-[#e8f0fe] border border-[#2d5aa0] rounded-full px-4 py-1 text-base">
        ...
        <div className="bg-gray-100 border-l-4 border-[#2d5aa0] rounded-r-lg p-3 mb-4">
          <p className="font-semibold text-[#2d5aa0] text-sm mb-1">为什么需要「降级」？</p>
        ...
        <Section num={1} title="主语从句" en="Subject Clause">
          <div className="bg-white border border-gray-200 rounded-lg p-3">
            ...
            <p className="text-sm text-gray-500 mt-2 text-center">他喜欢足球这件事让我们惊讶</p>
          </div>
        </Section>
        ...
        <Section num={2} title="宾语从句" en="Object Clause">
          <div className="bg-white border border-gray-200 rounded-lg p-3">
            ...
            <p className="text-sm text-gray-500 mt-2 text-center">他说他喜欢足球</p>
          </div>
        </Section>

        <div className="absolute bottom-4 right-6 font-mono text-sm text-gray-400">5</div>
      </div>
    </div>
  )
})
