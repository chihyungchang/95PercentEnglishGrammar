    ...
    >
      ...
      <div className="p-6 pl-14 h-full overflow-y-auto">
        ...
        <div className="text-center mb-4 pb-2 border-b-2 border-[#1a1a2e]">
          ...
          <p className="text-sm text-gray-500 mt-1">更多定②的例子</p>
        </div>
        ...
        <Section num={4} title="不定式短语作定语" en="Infinitive as Attributive">
          <div className="bg-white border border-gray-200 rounded-lg p-3">
            ...
            <p className="text-xs text-gray-500 mt-2 text-center">一个要解决的任务是潜在的危机</p>
          </div>
        </Section>
        ...
        <Section num={5} title="定语从句" en="Relative Clause">
          <div className="bg-white border border-gray-200 rounded-lg p-3">
            <p className="font-mono text-sm mb-2 text-center leading-relaxed">
            ...
            <p className="text-xs text-gray-500 mt-2 text-center">一个喜欢春天的女孩分享了一个打动我们的故事</p>
          </div>
        </Section>
        ...
        <div className="mt-4">
          <div className="flex items-center gap-2 mb-2">
            <span className="bg-[#d4a017] text-white text-xs px-2 py-1 rounded">终极综合版</span>
          </div>
          <div className="bg-[#fef9e7] border border-[#d4a017] rounded-lg p-3">
            <p className="font-mono text-xs leading-loose text-center">
        ...
        <div className="absolute bottom-4 right-6 font-mono text-xs text-gray-400">8</div>
      </div>
    </div>
  )
})
