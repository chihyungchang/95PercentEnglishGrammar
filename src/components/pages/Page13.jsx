    ...
    >
      ...
      <div className="p-6 pl-14 h-full overflow-y-auto">
        ...
        <div className="text-center mb-4 pb-2 border-b-2 border-[#1a1a2e]">
          ...
          <p className="text-base text-gray-500 mt-1">其实就是对六种基本句型的操纵</p>
        </div>
          ...
          <div className="space-y-3">
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-3">
              <div className="space-y-1.5">
                <p className="text-sm text-gray-500">他打了我：</p>
                <p className="font-mono text-base">He hit me.</p>
                <p className="text-sm text-gray-500 mt-2">是<span className="text-[#c0392b] font-bold">他</span>打了我：</p>
                <p className="font-mono text-base">
                  It <span className="text-[#8e44ad]">was</span> <span className="bg-[#c0392b] text-white px-1.5 py-0.5 rounded text-sm">him</span> that hit me.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-3">
              <div className="space-y-1.5">
                <p className="text-sm text-gray-500">我通过这个网站了解了这个项目：</p>
                <p className="font-mono text-sm">I learned about this project through this site.</p>
                <p className="text-sm text-gray-500 mt-2">就是<span className="text-[#2d5aa0] font-bold">通过这个网站</span>我才了解了这个项目：</p>
                <p className="font-mono text-sm">
                  It <span className="text-[#8e44ad]">was</span> <span className="bg-[#2d5aa0] text-white px-1.5 py-0.5 rounded text-xs">through this site</span> that I learned about this project.
                </p>
              </div>
            </div>
            ...
            <div className="bg-[#fef9e7] border border-[#d4a017] rounded-lg p-3">
              <p className="text-sm font-bold text-[#d4a017] mb-2">强调句公式：</p>
              ...
              <p className="text-xs text-gray-500 mt-2 text-center">↑ 被强调的内容</p>
            </div>
          </div>
        </Section>

        <div className="absolute bottom-4 right-6 font-mono text-sm text-gray-400">13</div>
      </div>
    </div>
  )
})
