    ...
    >
      ...
      <div className="p-6 pl-14 h-full overflow-y-auto">
        ...
        <div className="text-center mb-4 pb-2 border-b-2 border-[#1a1a2e]">
          ...
          <p className="text-sm text-gray-500 mt-1">Tenses</p>
        </div>
        ...
        <Section num={2} title="进行时态" en="Continuous Tense" subtitle="正在发生">
          ...
          <div className="bg-[#e8f0fe] border border-[#2d5aa0]/30 rounded-lg p-2 mt-2">
            <p className="font-mono text-xs">
              I <span className="bg-[#2d5aa0] text-white px-1 rounded text-[10px]">will be sleeping</span> by the time you come back.
            </p>
            <p className="text-[10px] text-gray-500 mt-1">你回来的时候我会在睡觉。</p>
          </div>
        </Section>
    ...
    <div className="bg-white border border-gray-200 rounded-lg p-3">
      ...
      <div className="flex items-center justify-center mb-3">
        ...
        <div className="flex-1 mx-2 relative h-6">
          ...
          <span className="absolute left-1/2 -translate-x-1/2 -top-1 text-[10px] text-[#2d5aa0]">现在</span>
        </div>
      ...
      <div className="grid grid-cols-3 gap-2 text-center">
        <div className="bg-gray-50 rounded p-2">
          <p className="font-mono text-xs text-[#c0392b] font-bold">{past.verb}</p>
          <p className="text-[10px] text-gray-500 mt-1">{past.cn}</p>
        </div>
        <div className="bg-[#2d5aa0]/10 rounded p-2 border border-[#2d5aa0]/30">
          <p className="font-mono text-xs text-[#2d5aa0] font-bold">{present.verb}</p>
          <p className="text-[10px] text-gray-500 mt-1">{present.cn}</p>
        </div>
        <div className="bg-gray-50 rounded p-2">
          <p className="font-mono text-xs text-[#1e8449] font-bold">{future.verb}</p>
          <p className="text-[10px] text-gray-500 mt-1">{future.cn}</p>
        </div>
      </div>
    </div>
  )
