    ...
    >
      ...
      <div className="p-6 pl-14 h-full overflow-y-auto">
        ...
        <div className="text-center mb-4 pb-2 border-b-2 border-[#1a1a2e]">
          ...
          <p className="text-base text-gray-500 mt-1">Non-finite Verbs (Participles)</p>
        </div>

        {/* 分词概述 */}
        <div className="bg-[#e8f0fe] border border-[#2d5aa0]/30 rounded-lg p-3 mb-4">
          <p className="text-base font-bold text-center mb-2">分词</p>
          <div className="grid grid-cols-2 gap-3">
            <div className="bg-white rounded p-2 text-center">
              <span className="bg-[#1e8449] text-white px-2 py-0.5 rounded text-sm font-mono">doing</span>
              <p className="text-sm mt-1 font-bold">现在分词</p>
              <p className="text-xs text-gray-500">和主句主语为<span className="text-[#1e8449] font-bold">主动</span>关系</p>
            </div>
            <div className="bg-white rounded p-2 text-center">
              <span className="bg-[#8e44ad] text-white px-2 py-0.5 rounded text-sm font-mono">done</span>
              <p className="text-sm mt-1 font-bold">过去分词</p>
              <p className="text-xs text-gray-500">和主句主语为<span className="text-[#8e44ad] font-bold">被动</span>关系</p>
            </div>
          </div>
        </div>
        ...
        <Section title="现在分词" tag="doing" color="#1e8449">
          <div className="bg-white border border-gray-200 rounded-lg p-3">
            ...
            <div className="bg-[#1e8449]/10 rounded p-2">
              ...
              <p className="text-xs text-gray-500 mt-1">（男孩主动去找，但没找到）</p>
            </div>
          </div>
        </Section>
        ...
        <Section title="过去分词" tag="done" color="#8e44ad">
          <div className="bg-white border border-gray-200 rounded-lg p-3">
            ...
            <div className="bg-[#8e44ad]/10 rounded p-2">
              ...
              <p className="text-xs text-gray-500 mt-1">（男孩被记忆力所害，被动承受）</p>
            </div>
          </div>
        </Section>

        <div className="absolute bottom-4 right-6 font-mono text-sm text-gray-400">20</div>
      </div>
    </div>
  )
})
  ...
  return (
    <div className="mb-4">
      <div className="flex items-center gap-2 mb-2">
        <span className="text-sm text-gray-500">例：</span>
